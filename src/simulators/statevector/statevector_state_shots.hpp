...
void State<statevec_t>::allocate(uint_t num_qubits,uint_t block_bits, uint_t parallel_shots)
{
  BaseState::qreg_.chunk_setup(num_qubits,num_qubits,0,parallel_shots);
}
